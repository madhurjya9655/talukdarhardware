      ...
      <div className="navbar bg-gray-800 text-white">
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content bg-gray-800 text-white rounded-box z-8 mt-3 w-52 p-2 shadow-lg"
            >
             {navItems}
            </ul>
          </div>
          <a className="btn btn-ghost text-2xl font-bold">Talukdar Hardware</a>
        </div>
    ...
    <path
      d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,8.14,8.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,8.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z" />
        ...
        <div className="navbar-end">
          <a href="#" className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer">Contact Us</a>
        </div>
        </div>
      </div>
    </>
